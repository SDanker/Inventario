            ...
            <div className="flex flex-wrap gap-2">
              ...
              {canPrepare && (
                <form action={handlePrepare} className="inline">
                  <Button type="submit" variant="secondary">Marcar como preparado</Button>
                </form>
              )}
              {canDispatch && (
                <form action={handleDispatch} className="inline">
                  <Button type="submit" variant="secondary">Despachar</Button>
                </form>
              )}
              {canReceive && (
                <form action={handleReceive} className="inline">
                  <Button type="submit" variant="primary">Marcar como recibido</Button>
                </form>
              )}
            </div>
          </CardBody>
